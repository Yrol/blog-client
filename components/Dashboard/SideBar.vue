<template>
  ...
  >
    <header
      class="flex justify-between items-center px-6 py-8 border-b border-gray-3 border-solid"
    >
      ...
      <AdminButton
        class="w-24 bg-gray-2 text-black-3 hover:bg-gray-3 hover:text-black-2"
        rounded
    ...
    return {
      notifications: [
        ...
        },
        {
          type: 'application',
          content:
            "To process your order, i'll need your full personnal etc etc",
          time: new Date(),
        },
        {
          type: 'complaint',
...
article {
  ...
  right: -18rem;
  opacity: 0;
  transition: transform 0.25s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.3s linear;
}
article.is-open {
